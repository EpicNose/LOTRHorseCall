...
public class HorseButton  extends LOTRGuiButtonMenu {
    public Class<? extends LOTRGuiMenuBase> menuScreenClass;
    public int menuKeyCode;

    public HorseButton(LOTRGuiMenu gui, int i, int x, int y, Class<? extends LOTRGuiMenuBase> cls, String s, int key) {
//        super(i, x, y, 32, 32, s);
        super(gui,8,0,0, HorseGui.class,"LOTR-召之马来",45);
        menuScreenClass = cls;
