...
import com.epicnose.lotrcallablehorse.lotr.client.gui.HorseButtonArrows;
...
public class HorseGuiRework extends LOTRGuiMenuBase {
...
//                    prevCallTime=System.currentTimeMillis();
                ...
                if(lpd.horseInfo!=null){
                    if(lpd.horseInfo.vehicles.size()>0 & index<lpd.horseInfo.vehicles.size()){
                        ...
                        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("[召之马来]成功召回"+index+"号载具"));
                    }
                }
